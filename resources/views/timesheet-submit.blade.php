                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 statistics">
                                ...
                                <p>Timesheet period: <span class="timesheet_period">{{$period_submit}}</span></p>
                                <p>Status: <span class="timesheet_status">{{$status}}</span></p>

                                @if($status == 'Open')
                                    <span class="submit_timesheet_wrap">
                                        <button class="btn btn-success" id="submit_timesheet">Submit</button>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 statistics">
                                ...
                                <table class="table table-striped total_hours">
                                    <thead>
                                    <tr>
                                        <th>Hours worked</th>
